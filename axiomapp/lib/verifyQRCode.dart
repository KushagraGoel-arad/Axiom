...
class verQrCode extends StatefulWidget {
  final String? selectedAppId2;
  final String? selecteduserid;
  const verQrCode({super.key, this.selectedAppId2, this.selecteduserid});

  @override
  State<verQrCode> createState() => _verQrCodeState();
}

class _verQrCodeState extends State<verQrCode> {
  bool _enabled = false;
  ...
  Future<void> verifyOTP() async {
    ...
    final authToken = prefs.getString('jwtToken');
    final userId1 = prefs.getString('userDetails');
    final appId = widget.selectedAppId2;
...
//   @override
//   State<verQrCode> createState() => verQrCodeState();
// }

// class verQrCodeState extends State<verQrCode> {
//   bool _enabled = false;
