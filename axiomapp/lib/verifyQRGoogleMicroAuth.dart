...
class verifyQRGoogleMicroAuth extends StatefulWidget {
  final String? selectedAppId1;
  final String? selectedUserId;
  const verifyQRGoogleMicroAuth(
      {super.key, this.selectedAppId1, this.selectedUserId});

  @override
  State<verifyQRGoogleMicroAuth> createState() =>
      _verifyQRGoogleMicroAuthState();
}
...
class _verifyQRGoogleMicroAuthState extends State<verifyQRGoogleMicroAuth> {
  ...
  Future<void> verifyOTP() async {
    ...
    final accountId = prefs.getString('accountId');
    final authToken = prefs.getString('jwtToken');
    final userId1 = widget.selectedUserId;
    final appId = widget.selectedAppId1;
...
// class verifyQRGoogleMicroAuth extends StatefulWidget {
//   verifyQRGoogleMicroAuth({
//     Key? key,
//   }) : super(key: key);

//   @override
//   State<verifyQRGoogleMicroAuth> createState() =>
//       verifyQRGoogleMicroAuthState();
// }

// class verifyQRGoogleMicroAuthState extends State<verifyQRGoogleMicroAuth> {
//   bool _enabled = false;
...
//   String enteredValue = '';
//   Future<void> verifyOTPSoft() async {
//     // Replace with your actual API endpoint URL
//     var ct = getCurrentDateTime();
...
//     // Update the URL and request parameters
//     final url = Uri.parse(
//       'https://access.axiomprotect.com:6653/AxiomProtect/v1/token/verifyOTP'
//       '?accountId=$accountId&userId=$userId1&appId=$appId&category=3&OTP=$enteredValue&requestTime=$ct',
//     );
...
//     double height = MediaQuery.of(context).size.height;
//     return Scaffold(
//       backgroundColor: Color.fromARGB(1, 235, 243, 250),
//       body: SingleChildScrollView(
//         child: Card(
//           elevation: 4,
